...
import { APIRes, Bootstrap, Controller, Get, HTTPStatus, BadRequestException, Exception } from "..";
    ...
    before(() => {
        ...
        class TestController {
            ...
            customException(): APIRes<null> {
                throw new Exception(HTTPStatus.IM_A_TEAPOT, "Custom Error", "Custom error message")
            }
        }
        app = express();
    ...
    it("Custom Exceptions", (done) => {
        request(app)
            ...
            .end((_, res) => {
                ...
                expect(res.body).to.haveOwnProperty("message", "Custom error message");
