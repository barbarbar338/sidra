...
import { APIRes, Bootstrap, Controller, Get, HTTPStatus, Ip, Param, Query } from "..";
    ...
    it("Using Param Decorators", (done) => {
        request(app)
            ...
            .end((_, res) => {
                ...
                expect(res.body).to.haveOwnProperty("message", "Test controller");
